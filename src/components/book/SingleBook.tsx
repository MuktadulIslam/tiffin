      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-8 md:py-12 flex flex-col md:flex-row gap-8 md:gap-14">
        ...
        <div className="flex flex-row md:flex-col items-center md:items-center gap-4 md:shrink-0">
          ...
          >
            ...
            />
            <div
              className="relative w-36 sm:w-44 md:w-52 rounded-2xl overflow-hidden bg-white"
              style={{
          ...
          <div className="flex flex-col md:flex-col gap-2 w-full md:w-52">
            {[
              ...
              <div
                key={String(l)}
                className="flex justify-between items-center px-3 md:px-4 py-2 md:py-2.5 rounded-xl bg-white shadow-sm border"
        ...
        <div className="flex-1 min-w-0">
          ...
          <h1
            className="text-2xl sm:text-3xl md:text-4xl font-black text-slate-800 mb-2 leading-tight"
            style={{ fontFamily: "'Georgia',serif" }}
          >
            {bk.title}
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-3 p-4 md:p-6 rounded-2xl bg-white shadow-lg border border-black/5">
            <div>
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-2xl md:text-3xl font-black" style={{ color: accent }}>
                  {fmt(bk.price)}
                </span>
